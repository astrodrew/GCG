...
_MODELS = {
    # "LLaMA-2-7B": ["/root/autodl-tmp/llms/Llama-2-7b-chat-hf", {"use_fast": False}, "llama-2", 64]
...
def main(_):
    ...
    print(params)
    params.logfile = '/root/msra/llm-attacks-main/experiments/results/individual_behavior_controls_llama3.json'
    ...
    for model in _MODELS:
        ...
        for goal, target, control in tqdm(zip(goals, targets, controls)):
