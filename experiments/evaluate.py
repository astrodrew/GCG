...
_MODELS = {
    ...
    # "MPT-7B": ["mosaicml/mpt-7b-chat", {"use_fast": True}, "mpt-7b-chat", 64]
     # "LLaMA-2-7B": ["/root/autodl-tmp/llms/Llama-2-7b-chat-hf", {"use_fast": False}, "llama-2", 16]
     # "vicuna": ["/root/autodl-tmp/llms/vicuna-7b-v1.5", {"use_fast": False}, "vicuna", 64]
    "LLaMA-3-8B": ["/root/autodl-tmp/llms/Meta-Llama-3-8B-Instruct", {"use_fast": False}, "llama-3", 64]
}

def main(_):

    params = _CONFIG.value
    # params.logfile = '/root/msra/llm-attacks-main/experiments/results/transfer_vicuna_gcg_25_progressive_20240809-23_20_25.json'
    # params.logfile = '/root/msra/llm-attacks-main/experiments/results/transfer_llama2_gcg_25_progressive_20240809-20:31:45.json'
    params.logfile = '/root/msra/llm-attacks-main/experiments/results/transfer_llama3_gcg_25_progressive_20240809-09_00_55.json'
    
    params.train_data="/root/msra/llm-attacks-main/data/advbench/harmful_behaviors.csv"
    params.n_train_data = 25
    params.n_test_data = 100
